...
| 文档 | 说明 |
|------|------|
| [安装部署教程](./docs/INSTALL.md) | 详细的安装步骤、环境变量配置、数据库切换说明 |
| [Authing 配置教程](./docs/AUTHING_CONFIG.md) | 微信扫码登录的完整配置流程、参数获取方法、常见问题排查 |
| [部署上线教程](./docs/DEPLOY.md) | 多种部署方式说明（Vercel/Docker/传统服务器）、生产环境注意事项、上线检查清单 |
